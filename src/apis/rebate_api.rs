...
pub async fn sapi_v1_rebate_tax_query_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, start_time: Option<i64>, end_time: Option<i64>, page: Option<i32>, recv_window: Option<i64>) -> Result<crate::models::SapiV1RebateTaxQueryGet200Response, Error<SapiV1RebateTaxQueryGetError>> {
