...
pub async fn sapi_v1_user_data_stream_post(configuration: &configuration::Configuration, ) -> Result<crate::models::ApiV3UserDataStreamDelete200Response, Error<SapiV1UserDataStreamPostError>> {
    let local_var_configuration = configuration;
