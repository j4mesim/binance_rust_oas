...
/// Weight(UID): 6000
pub async fn sapi_v1_loan_adjust_ltv_post(configuration: &configuration::Configuration, order_id: i64, amount: f64, direction: &str, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<crate::models::SapiV1LoanAdjustLtvPost200Response, Error<SapiV1LoanAdjustLtvPostError>> {
...
pub async fn sapi_v1_loan_borrow_history_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, order_id: Option<i64>, loan_coin: Option<&str>, collateral_coin: Option<&str>, start_time: Option<i64>, end_time: Option<i64>, current: Option<i32>, limit: Option<i64>, recv_window: Option<i64>) -> Result<crate::models::SapiV1LoanBorrowHistoryGet200Response, Error<SapiV1LoanBorrowHistoryGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(UID): 6000
pub async fn sapi_v1_loan_borrow_post(configuration: &configuration::Configuration, loan_coin: &str, collateral_coin: &str, loan_term: i32, timestamp: i64, signature: &str, loan_amount: Option<f64>, collateral_amount: Option<f64>, recv_window: Option<i64>) -> Result<crate::models::SapiV1LoanBorrowPost200Response, Error<SapiV1LoanBorrowPostError>> {
    let local_var_configuration = configuration;
...
/// If startTime and endTime are not sent, the recent 90-day data will be returned. The max interval between startTime and endTime is 180 days.  Weight(IP): 400
pub async fn sapi_v1_loan_repay_history_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, order_id: Option<i64>, loan_coin: Option<&str>, collateral_coin: Option<&str>, start_time: Option<i64>, end_time: Option<i64>, current: Option<i32>, limit: Option<i64>, recv_window: Option<i64>) -> Result<crate::models::SapiV1LoanRepayHistoryGet200Response, Error<SapiV1LoanRepayHistoryGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(UID): 6000
pub async fn sapi_v1_loan_repay_post(configuration: &configuration::Configuration, order_id: i64, amount: f64, timestamp: i64, signature: &str, r#type: Option<i32>, collateral_return: Option<bool>, recv_window: Option<i64>) -> Result<crate::models::SapiV1LoanRepayPost200Response, Error<SapiV1LoanRepayPostError>> {
    let local_var_configuration = configuration;
