...
pub async fn api_v3_account_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<crate::models::Account, Error<ApiV3AccountGetError>> {
...
pub async fn api_v3_all_order_list_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, from_id: Option<i64>, start_time: Option<i64>, end_time: Option<i64>, limit: Option<i32>, recv_window: Option<i64>) -> Result<Vec<crate::models::ApiV3AllOrderListGet200ResponseInner>, Error<ApiV3AllOrderListGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_all_orders_get(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, order_id: Option<i64>, start_time: Option<i64>, end_time: Option<i64>, limit: Option<i32>, recv_window: Option<i64>) -> Result<Vec<crate::models::OrderDetails>, Error<ApiV3AllOrdersGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_my_trades_get(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, order_id: Option<i64>, start_time: Option<i64>, end_time: Option<i64>, from_id: Option<i64>, limit: Option<i32>, recv_window: Option<i64>) -> Result<Vec<crate::models::MyTrade>, Error<ApiV3MyTradesGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(IP): 3
pub async fn api_v3_open_order_list_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<Vec<crate::models::ApiV3OpenOrderListGet200ResponseInner>, Error<ApiV3OpenOrderListGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_open_orders_delete(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<Vec<crate::models::ApiV3OpenOrdersDelete200ResponseInner>, Error<ApiV3OpenOrdersDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_open_orders_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, symbol: Option<&str>, recv_window: Option<i64>) -> Result<Vec<crate::models::OrderDetails>, Error<ApiV3OpenOrdersGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_cancel_replace_post(configuration: &configuration::Configuration, symbol: &str, side: &str, r#type: &str, cancel_replace_mode: &str, timestamp: i64, signature: &str, time_in_force: Option<&str>, quantity: Option<f64>, quote_order_qty: Option<f64>, price: Option<f64>, cancel_new_client_order_id: Option<&str>, cancel_orig_client_order_id: Option<&str>, cancel_order_id: Option<i64>, new_client_order_id: Option<&str>, strategy_id: Option<i64>, strategy_type: Option<i64>, stop_price: Option<f64>, trailing_delta: Option<f64>, iceberg_qty: Option<f64>, new_order_resp_type: Option<&str>, recv_window: Option<i64>) -> Result<crate::models::ApiV3OrderCancelReplacePost200Response, Error<ApiV3OrderCancelReplacePostError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_delete(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, order_id: Option<i64>, orig_client_order_id: Option<&str>, new_client_order_id: Option<&str>, recv_window: Option<i64>) -> Result<crate::models::Order, Error<ApiV3OrderDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_get(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, order_id: Option<i64>, orig_client_order_id: Option<&str>, recv_window: Option<i64>) -> Result<crate::models::OrderDetails, Error<ApiV3OrderGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_list_delete(configuration: &configuration::Configuration, symbol: &str, timestamp: i64, signature: &str, order_list_id: Option<i64>, list_client_order_id: Option<&str>, new_client_order_id: Option<&str>, recv_window: Option<i64>) -> Result<crate::models::OcoOrder, Error<ApiV3OrderListDeleteError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_list_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, order_list_id: Option<i64>, orig_client_order_id: Option<&str>, recv_window: Option<i64>) -> Result<crate::models::ApiV3OrderListDelete200Response, Error<ApiV3OrderListGetError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_order_test_post(configuration: &configuration::Configuration, symbol: &str, side: &str, r#type: &str, timestamp: i64, signature: &str, time_in_force: Option<&str>, quantity: Option<f64>, quote_order_qty: Option<f64>, price: Option<f64>, new_client_order_id: Option<&str>, strategy_id: Option<i64>, strategy_type: Option<i64>, stop_price: Option<f64>, trailing_delta: Option<f64>, iceberg_qty: Option<f64>, new_order_resp_type: Option<&str>, recv_window: Option<i64>) -> Result<serde_json::Value, Error<ApiV3OrderTestPostError>> {
    let local_var_configuration = configuration;
...
pub async fn api_v3_rate_limit_order_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<Vec<crate::models::ApiV3RateLimitOrderGet200ResponseInner>, Error<ApiV3RateLimitOrderGetError>> {
    let local_var_configuration = configuration;
