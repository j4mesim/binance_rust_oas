...
/// Weight(IP): 1
pub async fn sapi_v1_blvt_redeem_post(configuration: &configuration::Configuration, token_name: &str, amount: f64, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<crate::models::SapiV1BlvtRedeemPost200Response, Error<SapiV1BlvtRedeemPostError>> {
...
pub async fn sapi_v1_blvt_redeem_record_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, token_name: Option<&str>, id: Option<i64>, start_time: Option<i64>, end_time: Option<i64>, limit: Option<i32>, recv_window: Option<i64>) -> Result<Vec<crate::models::SapiV1BlvtRedeemRecordGet200ResponseInner>, Error<SapiV1BlvtRedeemRecordGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(IP): 1
pub async fn sapi_v1_blvt_subscribe_post(configuration: &configuration::Configuration, token_name: &str, cost: f64, timestamp: i64, signature: &str, recv_window: Option<i64>) -> Result<crate::models::SapiV1BlvtSubscribePost200Response, Error<SapiV1BlvtSubscribePostError>> {
    let local_var_configuration = configuration;
...
/// - Only the data of the latest 90 days is available  Weight(IP): 1
pub async fn sapi_v1_blvt_subscribe_record_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, token_name: Option<&str>, id: Option<i64>, start_time: Option<i64>, end_time: Option<i64>, limit: Option<i32>, recv_window: Option<i64>) -> Result<crate::models::SapiV1BlvtSubscribeRecordGet200Response, Error<SapiV1BlvtSubscribeRecordGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(IP): 1
pub async fn sapi_v1_blvt_token_info_get(configuration: &configuration::Configuration, token_name: Option<&str>) -> Result<Vec<crate::models::SapiV1BlvtTokenInfoGet200ResponseInner>, Error<SapiV1BlvtTokenInfoGetError>> {
    let local_var_configuration = configuration;
...
/// Weight(IP): 1
pub async fn sapi_v1_blvt_user_limit_get(configuration: &configuration::Configuration, timestamp: i64, signature: &str, token_name: Option<&str>, recv_window: Option<i64>) -> Result<Vec<crate::models::SapiV1BlvtUserLimitGet200ResponseInner>, Error<SapiV1BlvtUserLimitGetError>> {
    let local_var_configuration = configuration;
