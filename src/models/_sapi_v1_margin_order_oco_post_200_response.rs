...
pub struct SapiV1MarginOrderOcoPost200Response {
    ...
    #[serde(rename = "orders")]
    pub orders: Vec<crate::models::SapiV1MarginOrderOcoPost200ResponseOrdersInner>,
    #[serde(rename = "orderReports")]
    pub order_reports: Vec<crate::models::ApiV3OrderOcoPost200ResponseOrderReportsInner>,
}

impl SapiV1MarginOrderOcoPost200Response {
    pub fn new(order_list_id: i64, contingency_type: String, list_status_type: String, list_order_status: String, list_client_order_id: String, transaction_time: i64, symbol: String, margin_buy_borrow_amount: String, margin_buy_borrow_asset: String, is_isolated: bool, orders: Vec<crate::models::SapiV1MarginOrderOcoPost200ResponseOrdersInner>, order_reports: Vec<crate::models::ApiV3OrderOcoPost200ResponseOrderReportsInner>) -> SapiV1MarginOrderOcoPost200Response {
        SapiV1MarginOrderOcoPost200Response {
            order_list_id,
            contingency_type,
            list_status_type,
