...
pub struct IsolatedMarginAccountInfoAssetsInner {
    ...
    pub base_asset: Box<crate::models::IsolatedMarginAccountInfoAssetsInnerBaseAsset>,
    #[serde(rename = "quoteAsset")]
    pub quote_asset: Box<crate::models::IsolatedMarginAccountInfoAssetsInnerQuoteAsset>,
    #[serde(rename = "symbol")]
    pub symbol: String,
...
impl IsolatedMarginAccountInfoAssetsInner {
    pub fn new(base_asset: crate::models::IsolatedMarginAccountInfoAssetsInnerBaseAsset, quote_asset: crate::models::IsolatedMarginAccountInfoAssetsInnerQuoteAsset, symbol: String, isolated_created: bool, enabled: bool, margin_level: String, margin_level_status: String, margin_ratio: String, index_price: String, liquidate_price: String, liquidate_rate: String, trade_enabled: bool) -> IsolatedMarginAccountInfoAssetsInner {
