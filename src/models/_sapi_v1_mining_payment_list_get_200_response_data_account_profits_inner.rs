...
impl SapiV1MiningPaymentListGet200ResponseDataAccountProfitsInner {
    pub fn new(time: i64, r#type: i64, hash_transfer: i32, transfer_amount: f32, day_hash_rate: i64, profit_amount: f64, coin_name: String, status: i32) -> SapiV1MiningPaymentListGet200ResponseDataAccountProfitsInner {
