...
pub struct SapiV1MiningStatisticsUserStatusGet200ResponseData {
    ...
    pub profit_today: Box<crate::models::SapiV1MiningStatisticsUserStatusGet200ResponseDataProfitToday>,
    #[serde(rename = "profitYesterday")]
    pub profit_yesterday: Box<crate::models::SapiV1MiningStatisticsUserStatusGet200ResponseDataProfitToday>,
...
impl SapiV1MiningStatisticsUserStatusGet200ResponseData {
    pub fn new(fifteen_min_hash_rate: String, day_hash_rate: String, valid_num: i64, invalid_num: i64, profit_today: crate::models::SapiV1MiningStatisticsUserStatusGet200ResponseDataProfitToday, profit_yesterday: crate::models::SapiV1MiningStatisticsUserStatusGet200ResponseDataProfitToday, user_name: String, unit: String, algo: String) -> SapiV1MiningStatisticsUserStatusGet200ResponseData {
