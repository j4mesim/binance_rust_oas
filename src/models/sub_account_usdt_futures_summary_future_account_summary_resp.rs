...
pub struct SubAccountUsdtFuturesSummaryFutureAccountSummaryResp {
    ...
    pub sub_account_list: Vec<crate::models::SubAccountUsdtFuturesSummaryFutureAccountSummaryRespSubAccountListInner>,
}

impl SubAccountUsdtFuturesSummaryFutureAccountSummaryResp {
    pub fn new(total_initial_margin: String, total_maintenance_margin: String, total_margin_balance: String, total_open_order_initial_margin: String, total_position_initial_margin: String, total_unrealized_profit: String, total_wallet_balance: String, asset: String, sub_account_list: Vec<crate::models::SubAccountUsdtFuturesSummaryFutureAccountSummaryRespSubAccountListInner>) -> SubAccountUsdtFuturesSummaryFutureAccountSummaryResp {
