...
pub struct SapiV1CapitalConfigGetallGet200ResponseInner {
    ...
    pub network_list: Vec<crate::models::SapiV1CapitalConfigGetallGet200ResponseInnerNetworkListInner>,
