...
pub struct ApiV3ExchangeInfoGet200ResponseSymbolsInner {
    ...
    pub filters: Vec<crate::models::ApiV3ExchangeInfoGet200ResponseSymbolsInnerFiltersInner>,
    #[serde(rename = "permissions")]
    pub permissions: Vec<String>,
}

impl ApiV3ExchangeInfoGet200ResponseSymbolsInner {
    pub fn new(symbol: String, status: String, base_asset: String, base_asset_precision: i32, quote_asset: String, quote_asset_precision: i32, base_commission_precision: i32, quote_commission_precision: i32, order_types: Vec<String>, iceberg_allowed: bool, oco_allowed: bool, quote_order_qty_market_allowed: bool, allow_trailing_stop: bool, is_spot_trading_allowed: bool, is_margin_trading_allowed: bool, filters: Vec<crate::models::ApiV3ExchangeInfoGet200ResponseSymbolsInnerFiltersInner>, permissions: Vec<String>) -> ApiV3ExchangeInfoGet200ResponseSymbolsInner {
