...
pub struct SapiV1SubAccountFuturesAccountGet200Response {
    ...
    pub asset: String,
    #[serde(rename = "assets")]
    pub assets: Vec<crate::models::SapiV1SubAccountFuturesAccountGet200ResponseAssetsInner>,
