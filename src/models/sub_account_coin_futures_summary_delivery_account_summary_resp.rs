...
pub struct SubAccountCoinFuturesSummaryDeliveryAccountSummaryResp {
    ...
    pub sub_account_list: Vec<crate::models::SubAccountCoinFuturesSummaryDeliveryAccountSummaryRespSubAccountListInner>,
}

impl SubAccountCoinFuturesSummaryDeliveryAccountSummaryResp {
    pub fn new(total_margin_balance_of_btc: String, total_unrealized_profit_of_btc: String, total_wallet_balance_of_btc: String, asset: String, sub_account_list: Vec<crate::models::SubAccountCoinFuturesSummaryDeliveryAccountSummaryRespSubAccountListInner>) -> SubAccountCoinFuturesSummaryDeliveryAccountSummaryResp {
