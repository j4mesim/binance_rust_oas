...
pub struct SapiV1LoanRepayPost200Response {
...
impl SapiV1LoanRepayPost200Response {
    pub fn new(loan_coin: String, remaining_principal: String, remaining_interest: String, collateral_coin: String, remaining_collateral: String, current_ltv: String, repay_status: String) -> SapiV1LoanRepayPost200Response {
